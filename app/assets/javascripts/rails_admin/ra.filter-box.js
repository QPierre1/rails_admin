  ...
  $.filters = filters = {
    append: function (options) {
          ...
          control = $(
            ...
            .add(
              $('<a href="#" class="switch-select"></a>').append(
                $("<i></i>").addClass(
                  "icon-" + (multiple_values ? "minus" : "plus")
                )
              )
            );
          break;
      ...
      var $content = $("<p>")
        ...
        .append("&nbsp;")
        .append(
          $('<span class="label label-info form-label"></span>').append(
            $('<a href="#delete" class="delete"></a>')
              .append('<i class="fa fa-trash-o fa-fw icon-white"></i>')
